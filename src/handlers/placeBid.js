...
async function placeBid(event, context) {
  ...
  if (auction.status !== 'OPEN') {
    throw new createError.Forbidden('You cannot bid on closed options');
  }

  // The highest bid must be greater than the current bid
  ...
  // Highest bidders can't bid while they have the highest bid
